...
def signup_post():
    ...
    new_user = User(email=email, name=name, password=generate_password_hash(password=password))
    #new_user.password = generate_password_hash(new_user.password, method= 'sha256', salt_length=0)
